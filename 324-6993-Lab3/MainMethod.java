...
This lab is the implementation of semaphores for the readers and writers classical synchronization problem with readers having priority.
The writers will have priority over the readers. 
*/
...
public class MainMethod {
  public static void main (String argv[]) {
    ...
    //the reader and writer semaphores for the readers and the writers
    Synch.readQueue = new Semaphore(0, true);
    Synch.writeQueue = new Semaphore(0, true);
